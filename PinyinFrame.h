...
public:
	...
	QPinyinFrame(QWidget* parent=0, const char* name=0, Qt::WindowFlags f=0);
	virtual ~QPinyinFrame();
...
public:
    ...
    QChar get_char(unsigned int nIndex/*this is global index*/)
    {
        return m_engine.get_char(nIndex);
    }
	
    QString get_phrase(unsigned int nIndex/*this is global index*/)
    {
